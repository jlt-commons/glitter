(ns glitter.genum
  ...
  GObject type registry — so glitter carries NO enum-constant tables.
  ...
  GtkOrientation. glitter applies these props in the :apply step, by which point
  ...
  in the registry and must be declared explicitly where truly needed (glitter
  has none for layout)."
